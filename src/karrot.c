...
{
    /* lvl cst fail spell */
    {  1,  1, 25, detect_monsters_spell},
    {  4,  3, 30, scare_spell},
    {  7,  4, 35, lightning_bolt_spell},
    { 10,  5, 35, heroism_spell},
    { 13,  3, 40, _sleep_monster_spell},
    { 16,  8, 45, _confuse_monster_spell},
    { 19, 10, 50, mind_blast_spell},
    { 22, 12, 50, floating_spell},
    { 25, 30, 55, _thundershadow_spell},
    { 28, 20, 55, fire_ball_spell},
    { 31, 10, 50, phase_door_spell},
    { 34, 25, 55, _mana_bolt_spell},
    { 37, 40, 60, dominate_living_I_spell},
    { 40, 50, 60, _force_field_spell},
    { 43, 50, 65, _device_focus_spell},
    { 46, 80, 70, _generate_storm_spell},
    { 49, 100, 75, _polymorph_dragon_spell},
    { -1, -1, -1, NULL},
};
