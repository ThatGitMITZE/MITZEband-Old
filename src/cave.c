        ...
        if (c_ptr->info & CAVE_MARK)
        {
            if (have_flag(f_info[c_ptr->mimic].flags, FF_ROGUE_TRAP_1))
            {
                ...
                case 1: /* Sleep */
                    ...
                    project(0, 1, m_ptr->fy, m_ptr->fx, p_ptr->lev, GF_OLD_SLEEP, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    break;
                case 2: /* Confuse */
                    if (m_ptr->ml)
                        msg_format("A gas of scintillating colors surrounds %s!", m_name);
                    project(0, 3, y, x, p_ptr->lev, GF_OLD_CONF, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    break;
                case 3: /* Slow */
                    if (m_ptr->ml)
                        msg_format("%s is hit by a small dart.", m_name);
                    project(0, 1, m_ptr->fy, m_ptr->fx, p_ptr->lev, GF_OLD_SLOW, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    break;
                case 4: /* Teleport */
                ...
                case 6: case 7: case 8: case 9: /* Arrow Trap */
                    ...
                    project(0, 1, m_ptr->fy, m_ptr->fx, p_ptr->lev/2 + damroll(5, 5), GF_MISSILE, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    break;
                }
            }
            else if (have_flag(f_info[c_ptr->mimic].flags, FF_ROGUE_TRAP_2))
            {
                ...
                case 1: /* Seeker Bolt */
                    ...
                    project(0, 1, m_ptr->fy, m_ptr->fx, 4*(damroll(6, 5) + p_ptr->lev/2), GF_MISSILE, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    break;
                case 2: /* Sound Ball */
                    if (m_ptr->ml)
                        msg_format("%s is hit by a ball of sound.", m_name);
                    project(0, 2, y, x, 2*(damroll(10, 10) + p_ptr->lev), GF_SOUND, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    break;
                case 3: /* Shard Ball */
                    if (m_ptr->ml)
                        msg_format("%s is hit by a large rock.", m_name);
                    project(0, 2, y, x, damroll(10, 10) + 3*p_ptr->lev, GF_SHARDS, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    break;
                case 4: /* Elemental Balls */
                    if (m_ptr->ml)
                        msg_format("%s is hit by a shower of elements.", m_name);
                    project(0, 2, y, x, 2*(damroll(7, 7) + p_ptr->lev/2), GF_FIRE, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    project(0, 2, y, x, 2*(damroll(7, 7) + p_ptr->lev/2), GF_COLD, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    project(0, 2, y, x, 2*(damroll(7, 7) + p_ptr->lev/2), GF_ELEC, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    project(0, 2, y, x, 2*(damroll(7, 7) + p_ptr->lev/2), GF_ACID, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    project(0, 2, y, x, 2*(damroll(7, 7) + p_ptr->lev/2), GF_POIS, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    break;
                case 5: /* Disintegration Ball */
                    if (m_ptr->ml)
                        msg_format("%s is hit by a disintegration ball.", m_name);
                    project(0, 5, y, x, 2*(damroll(10, 10) + 3*p_ptr->lev), GF_DISINTEGRATE, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    break;
                case 6: /* Stasis */
                    project(0, 1, m_ptr->fy, m_ptr->fx, 4*p_ptr->lev, GF_STASIS, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    break;
                case 7: /* Piranha Trap */
                {
                    int i, num;
                    msg_print("Your trap explodes and suddenly the room is filled with water and piranhas!");
                    project(0, 10, y, x, 100, GF_DISINTEGRATE, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    project(0, 10, y, x, 1, GF_WATER_FLOW, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI | PROJECT_HIDE));
            ...
            else if (have_flag(f_info[c_ptr->mimic].flags, FF_ROGUE_TRAP_3))
            {
                ...
                case 2: /* Hell Trap */
                {
                    ...
                    project(0, 10, y, x, 100, GF_DISINTEGRATE, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    project(0, 10, y, x, 1, GF_LAVA_FLOW, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI | PROJECT_HIDE));
                ...
                case 4: /* Mana Storm */
                    ...
                    project(0, 5, y, x, 2*400, GF_DISINTEGRATE, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    break;
                case 5: /* Rocket */
                    if (m_ptr->ml)
                        msg_format("%s is hit by a Rocket.", m_name);
                    project(0, 5, y, x, 2*400, GF_SHARDS, (PROJECT_GRID | PROJECT_ITEM | PROJECT_KILL | PROJECT_JUMP | PROJECT_NO_HANGEKI));
                    break;
                case 6: /* Dragon Trap */
                {
                    int i, num;
