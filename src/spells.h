...
extern int  choose_spell(spell_info* spells, int ct, cptr desc, int max_cost, bool power);
...
extern void absconding_spell(int cmd, variant *res);
...
extern void bunshin_spell(int cmd, variant *res);
...
extern void floating_spell(int cmd, variant *res);
...
extern void hide_in_leaves_spell(int cmd, variant *res);
extern void hide_in_mist_spell(int cmd, variant *res);
extern void hide_in_mud_spell(int cmd, variant *res);
extern void hit_and_away_spell(int cmd, variant *res);
...
extern void kawarimi_spell(int cmd, variant *res);
...
extern void nyusin_spell(int cmd, variant *res);
...
extern void syuriken_spreading_spell(int cmd, variant *res);
